<%-- 
    Document   : index
    Created on : 7 oct. 2021, 12:56:03
    Author     : Milagros
--%>
...
<html>
    ...
    <body>
        ...
        <div class="h-60 p-3 text-white bg-dark rounded-9">
        <div class="container text-light">
            <form action="ServletLogin">
              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Codigo de usuario</label>
                <input type="text" class="form-control" name="txtUsu" aria-describedby="emailHelp">
                <div id="emailHelp" class="form-text">Nunca compartiremos su correo electrónico con nadie más.</div>
              </div>
              <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Password</label>
                <input type="text" class="form-control" name="txtPas">
              </div>
